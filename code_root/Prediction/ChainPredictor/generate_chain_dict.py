...
while curr_time < end_time:
    ...
    sampled_chains = pickle.load(
        ...
        #  'rb'))
        open('../../../data/chain_data/stationary_chains_60' + '/predictions_' + str(curr_number) + '.pickle',
             'rb'))
...
pickle.dump(all_chains, open('../../../data/chain_data/stationary_chains_60_v1.pickle', 'wb'))
